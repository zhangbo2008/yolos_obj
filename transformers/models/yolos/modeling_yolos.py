...
class YolosEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor) -> torch.Tensor:
        ...
        position_embeddings = self.interpolation(self.position_embeddings, (height, width)) #4251差值变成了1145
...
class YolosPatchEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.projection = nn.Conv2d(num_channels, hidden_size, kernel_size=patch_size, stride=patch_size)#使用kernal=stride=patch_size即可.等价于patchify.
